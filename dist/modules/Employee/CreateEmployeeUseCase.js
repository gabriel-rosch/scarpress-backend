...
var CreateEmployeeUseCase = /** @class */ (function () {
    function CreateEmployeeUseCase() {
    }
    CreateEmployeeUseCase.prototype.execute = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var employeeExist, employee;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prismaClient_1.prisma.employee.findFirst({
                            where: {
                                name: {
                                    equals: data.name,
                                    mode: "insensitive"
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prismaClient_1.prisma.employee.create({
                                data: data
                            })];
                    case 2:
                        employee = _a.sent();
