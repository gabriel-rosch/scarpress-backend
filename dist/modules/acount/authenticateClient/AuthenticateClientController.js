...
var AuthenticateClientController = /** @class */ (function () {
    function AuthenticateClientController() {
    }
    AuthenticateClientController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, password, authenticateClientUseCase, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, username = _a.username, password = _a.password;
                        authenticateClientUseCase = new AuthenticateClientUseCase_1.AuthenticateClientUseCase();
...
//# sourceMappingURL=AuthenticateClientController.js.map